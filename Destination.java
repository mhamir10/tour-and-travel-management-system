...
public class Destination extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            l2.setVisible(true);
            caption.setText("COX'S BAZAR");
            l2.add(caption);
            Thread.sleep(2800);
            l2.setVisible(false);
            l3.setVisible(true);
            caption.setText("Saint Martin");
            l3.add(caption);
            l3.setVisible(true);
            Thread.sleep(2800);
            l3.setVisible(false);
            l4.setVisible(true);
            caption.setText("Switzerland");
            l4.add(caption);
            Thread.sleep(2800);
            l4.setVisible(false);
            l5.setVisible(true);
            ...
            l5.setVisible(false);
            l6.setVisible(true);
            caption.setText("Nepal");
            l6.add(caption);
            Thread.sleep(2800);
            l6.setVisible(false);
            l7.setVisible(true);
            caption.setText("Mount Avarest");
            l7.add(caption);
            Thread.sleep(2800);
            l7.setVisible(false);
            l8.setVisible(true);
            caption.setText("Aman Hotel");
            l8.add(caption);
            Thread.sleep(2800);
            l8.setVisible(false);
            l9.setVisible(true);
            caption.setText("Srilanka");
            l9.add(caption);
            Thread.sleep(2800);
            l9.setVisible(false);
            l10.setVisible(true);
            caption.setText("The Taj Hotel");
            l10.add(caption);
            Thread.sleep(2800);
            l10.setVisible(false);
            l11.setVisible(true);
            caption.setText("India");
            l11.add(caption);
            Thread.sleep(2800);
    ...
    public Destination() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/11.jpeg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/12.jpg"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/13.jpeg"));
       ...
       l4.setVisible(false);
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icons/14.jpg"));
       ...
       l5.setVisible(false);
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/15.jpeg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("icons/16.jpg"));
       ...
       l7.setVisible(false);
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icons/17.jpeg"));
       ...
       l8.setVisible(false);
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("icons/18.jpg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("icons/19.jpg"));
        ...
        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("icons/2018.jpg"));
