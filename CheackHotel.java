...
public class CheackHotel extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            l2.setVisible(true);
            caption.setText("Raddison Blue");
            l2.add(caption);
            Thread.sleep(2800);
            l2.setVisible(false);
            l3.setVisible(true);
            caption.setText("Shonarga Hotel");
            l3.add(caption);
            l3.setVisible(true);
            Thread.sleep(2800);
            l3.setVisible(false);
            l4.setVisible(true);
            caption.setText("Crowne Plaza");
            l4.add(caption);
            Thread.sleep(2800);
            l4.setVisible(false);
            l5.setVisible(true);
            caption.setText("Hotel Simons");
            l5.add(caption);
            Thread.sleep(2800);
            l5.setVisible(false);
            l6.setVisible(true);
            caption.setText("Sheraton");
            l6.add(caption);
            Thread.sleep(2800);
            l6.setVisible(false);
            l7.setVisible(true);
            ...
            l11.setVisible(true);
            caption.setText("the Grand Ressort");
            l11.add(caption);
            Thread.sleep(2800);
    ...
    public CheackHotel() {
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/3.jpg"));
       ...
       l4.setVisible(false);
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icons/4.jpg"));
       ...
       l5.setVisible(false);
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/5.jpg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("icons/6.jpg"));
       ...
       l7.setVisible(false);
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icons/7.jpg"));
       ...
       l8.setVisible(false);
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("icons/8.jpg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("icons/9.jpg"));
        ...
        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("icons/10.jpg"));
    ...
    public static void main(String args[]) {
        new CheackHotel().setVisible(true);
